package com.luomor.liteav.demo.lvb.liveroom.roomutil.misc;
...
public class HintDialog extends Dialog implements View.OnClickListener {
    ...
    public HintDialog(@NonNull Context context) {
        this(context, com.luomor.liteav.demo.lvb.R.style.RtmpRoomDialogTheme);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.luomor.liteav.demo.lvb.R.layout.layout_rtmproom_hint_dialog);
        mContent = ((TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_hint_dialog_content));
        mOkButton = ((TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_hint_dialog_confirm_button));
        mTitle = ((TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_hint_dialog_title));
        if (buttonText != null){
