...
import com.luomor.liteav.demo.lvb.common.utils.FileUtils;
...
public class PusherBGMFragment extends DialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.luomor.liteav.demo.lvb.R.layout.fragment_pusher_bgm, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mEtLoop = (EditText) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_et_bgm_loop);

        mCbOnline = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_online));

        ((SeekBar) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_sb_mic)).setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
        ...
        ((SeekBar) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_sb_bgm)).setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        ((SeekBar) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_sb_bgm_pitch)).setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            @Override
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_btn_start).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_btn_resume).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnBGMControllCallback callback = getCallback();
                if (callback != null) {
        ...
        view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_btn_pause).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnBGMControllCallback callback = getCallback();
                if (callback != null) {
        ...
        view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_btn_stop).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnBGMControllCallback callback = getCallback();
                if (callback != null) {
