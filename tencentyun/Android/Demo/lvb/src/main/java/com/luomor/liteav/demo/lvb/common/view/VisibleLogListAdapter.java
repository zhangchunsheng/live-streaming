...
public class VisibleLogListAdapter extends RecyclerView.Adapter<VisibleLogListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = View.inflate(parent.getContext(), com.luomor.liteav.demo.lvb.R.layout.item_visible_log, null);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(final View itemView) {
            super(itemView);
            warning = (TextView) itemView.findViewById(com.luomor.liteav.demo.lvb.R.id.tv_warning);
        }
    }
