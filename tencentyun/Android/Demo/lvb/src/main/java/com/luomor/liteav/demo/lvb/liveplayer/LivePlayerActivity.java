package com.luomor.liteav.demo.lvb.liveplayer;
...
import com.luomor.liteav.demo.lvb.common.activity.QRCodeScanActivity;
import com.luomor.liteav.demo.lvb.common.view.TXPlayVisibleLogView;
...
public class LivePlayerActivity extends Activity implements ITXLivePlayListener, View.OnClickListener{
    ...
    private void setContentView() {
        setContentView(com.luomor.liteav.demo.lvb.R.layout.activity_play);
        mRtmpUrlView   = (EditText) findViewById(com.luomor.liteav.demo.lvb.R.id.roomid);
        Button scanBtn = (Button)findViewById(com.luomor.liteav.demo.lvb.R.id.btnScan);
        ...
        mRootView = (LinearLayout) findViewById(com.luomor.liteav.demo.lvb.R.id.root);
        if (mLivePlayer == null) {
            mLivePlayer = new TXLivePlayer(this);
        }

        mPlayerView = (TXCloudVideoView) findViewById(com.luomor.liteav.demo.lvb.R.id.video_view);
        mPlayerView.setLogMargin(12, 12, 110, 60);
        mPlayerView.showLog(false);
        mLoadingView = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.loadingImageView);
...
//           mRtmpUrlView.setText("rtmp://live.hkstv.hk.lxdns.com/live/hks");
        ...
        mBtnPlay = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnPlay);
        ...
        mPlayVisibleLogView = (TXPlayVisibleLogView) findViewById(com.luomor.liteav.demo.lvb.R.id.visibleLogView);

        mBtnLog = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnLog);
        mBtnLog.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count == 0) {
                    mBtnLog.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.log_hidden);
                    ...
                    mBtnLog.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.log_show);
                    mPlayerView.showLog(false);
                }
            }
        });
        ...
        //横屏|竖屏
        mBtnRenderRotation = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnOrientation);
        mBtnRenderRotation.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentRenderRotation == TXLiveConstants.RENDER_ROTATION_PORTRAIT) {
                    mBtnRenderRotation.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.portrait);
                    mCurrentRenderRotation = TXLiveConstants.RENDER_ROTATION_LANDSCAPE;
                } else if (mCurrentRenderRotation == TXLiveConstants.RENDER_ROTATION_LANDSCAPE) {
                    mBtnRenderRotation.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.landscape);
                    mCurrentRenderRotation = TXLiveConstants.RENDER_ROTATION_PORTRAIT;
                }
        ...
        //平铺模式
        mBtnRenderMode = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnRenderMode);
        mBtnRenderMode.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentRenderMode == TXLiveConstants.RENDER_MODE_FULL_FILL_SCREEN) {
                    mBtnRenderMode.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.fill_mode);
                    mCurrentRenderMode = TXLiveConstants.RENDER_MODE_ADJUST_RESOLUTION;
                } else if (mCurrentRenderMode == TXLiveConstants.RENDER_MODE_ADJUST_RESOLUTION) {
                    mBtnRenderMode.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.adjust_mode);
        ...
        //硬件解码
        mBtnHWDecode = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnHWDecode);
        ...
        //缓存策略
        mBtnCacheStrategy = (Button)findViewById(com.luomor.liteav.demo.lvb.R.id.btnCacheStrategy);
        mLayoutCacheStrategy = (LinearLayout)findViewById(com.luomor.liteav.demo.lvb.R.id.layoutCacheStrategy);
        ...
        mRatioFast = (Button)findViewById(com.luomor.liteav.demo.lvb.R.id.radio_btn_fast);
        ...
        mRatioSmooth = (Button)findViewById(com.luomor.liteav.demo.lvb.R.id.radio_btn_smooth);
        ...
        mRatioAuto = (Button)findViewById(com.luomor.liteav.demo.lvb.R.id.radio_btn_auto);
        ...
        Button help = (Button)findViewById(com.luomor.liteav.demo.lvb.R.id.btnHelp);
        ...
        mBtnAcc = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnAcc);
        mBtnAcc.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mIsAcc) {
                    ...
                    findViewById(com.luomor.liteav.demo.lvb.R.id.btnCacheStrategyMargin).setVisibility(View.VISIBLE);
                    mActivityType = ACTIVITY_TYPE_LIVE_PLAY;
                    mRtmpUrlView.setText(NORMAL_PLAY_URL);
                    mBtnAcc.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.acc_on);
                } else {
                    mIsAcc = true;
                    mBtnCacheStrategy.setVisibility(View.GONE);
                    findViewById(com.luomor.liteav.demo.lvb.R.id.btnCacheStrategyMargin).setVisibility(View.GONE);
                    mActivityType = ACTIVITY_TYPE_REALTIME_PLAY;
                    mRtmpUrlView.setText("");
                    fetchPushUrl();
                    mBtnAcc.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.acc_off);
                }
                if (mIsPlaying) {
                    stopPlay();
                    //mIsPlaying = startPlay();
        ...
        findViewById(com.luomor.liteav.demo.lvb.R.id.webrtc_link_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        LinearLayout backLL = (LinearLayout)findViewById(com.luomor.liteav.demo.lvb.R.id.back_ll);
        ...
        TextView titleTV = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.title_tv);
        titleTV.setText(getIntent().getStringExtra("TITLE"));

        checkPublishPermission();

        Button btnPlay = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnPlay);
        if (btnPlay != null) {
    ...
    private void enableQRCodeBtn(boolean bEnable) {
        Button btnScan = (Button) findViewById(com.luomor.liteav.demo.lvb.R.id.btnScan);
        if (btnScan != null) {
    ...
    private boolean startPlay() {
        ...
        mBtnPlay.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.play_pause);
        ...
        if (result != 0) {
            mBtnPlay.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.play_start);
            mRootView.setBackgroundResource(com.luomor.liteav.demo.lvb.R.drawable.main_bkg);
            return false;
        }
