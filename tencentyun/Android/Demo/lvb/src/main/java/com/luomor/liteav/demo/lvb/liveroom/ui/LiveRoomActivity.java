...
import com.luomor.liteav.demo.lvb.liveroom.debug.GenerateTestUserSig;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.commondef.AudienceInfo;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.misc.CommonAppCompatActivity;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.misc.NameGenerator;
import com.luomor.liteav.demo.lvb.liveroom.ui.fragment.LiveRoomChatFragment;
import com.luomor.liteav.demo.lvb.liveroom.IMLVBLiveRoomListener;
import com.luomor.liteav.demo.lvb.liveroom.ui.fragment.LiveRoomListFragment;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.commondef.AnchorInfo;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.commondef.LoginInfo;
...
public class LiveRoomActivity extends CommonAppCompatActivity implements LiveRoomActivityInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(com.luomor.liteav.demo.lvb.R.style.BeautyTheme);
        setContentView(com.luomor.liteav.demo.lvb.R.layout.activity_live_room);

        findViewById(com.luomor.liteav.demo.lvb.R.id.liveroom_back_button).setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        titleTextView = ((TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.liveroom_title_textview));
        ...
        globalLogTextview = ((TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.liveroom_global_log_textview));
        globalLogTextview.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                new AlertDialog.Builder(LiveRoomActivity.this, com.luomor.liteav.demo.lvb.R.style.RtmpRoomDialogTheme)
                        .setTitle("Global Log")
                        .setMessage("清除Log")
        ...
        findViewById(com.luomor.liteav.demo.lvb.R.id.liveroom_link_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                        + ", mode = " + mAudioManager.getMode(), Toast.LENGTH_SHORT).show();
        ...
        globalLogTextviewContainer = ((ScrollView) findViewById(com.luomor.liteav.demo.lvb.R.id.liveroom_global_log_container));
    ...
    public void onBackPressed() {
        Fragment fragment = getFragmentManager().findFragmentById(com.luomor.liteav.demo.lvb.R.id.rtmproom_fragment_container);
    ...
    public void onPermissionDisable() {
        new AlertDialog.Builder(this, com.luomor.liteav.demo.lvb.R.style.RtmpRoomDialogTheme)
        ...
        liveRoom.login(loginInfo, new IMLVBLiveRoomListener.LoginCallback() {
            ...
            public void onSuccess() {
                ...
                if (!(fragment instanceof LiveRoomChatFragment)) {
                    ...
                    ft.replace(com.luomor.liteav.demo.lvb.R.id.rtmproom_fragment_container, fragment);
                    ft.commit();
                }
            }
        });
