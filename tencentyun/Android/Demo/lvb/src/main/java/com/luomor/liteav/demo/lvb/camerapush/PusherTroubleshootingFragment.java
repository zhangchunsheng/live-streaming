package com.luomor.liteav.demo.lvb.camerapush;
...
import com.luomor.liteav.demo.lvb.common.view.VisibleLogListAdapter;
...
public class PusherTroubleshootingFragment extends DialogFragment implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NO_TITLE, com.luomor.liteav.demo.lvb.R.style.room_setting_dlg);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View view =  inflater.inflate(com.luomor.liteav.demo.lvb.R.layout.fragment_pusher_troubleshooting, container, false);
        mCatonRecyclerView = (RecyclerView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.recycler_view);
        ...
        mTvFpsGop = (TextView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.tv_fpsgop);
        mTvBrand = (TextView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.tv_brand);
        mTvBitrate = (TextView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.tv_bitrate);
        mTvSpeed = (TextView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.tv_speed);
        mTvEncoder = (TextView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.tv_seg4);
        mIvClose = (ImageView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.iv_close);
        mIvQue = (ImageView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.iv_que);
        mIvStep1 = (ImageView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step1);
        mIvStep2 = (ImageView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step2);
        mIvStep3 = (ImageView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step3);
        mIvStep4 = (ImageView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step4);
        mIvStep5 = (ImageView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step5);
