...
public class PusherMoreFragment extends DialogFragment implements CompoundButton.OnCheckedChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setStyle(STYLE_NO_TITLE, com.luomor.liteav.demo.lvb.R.style.mlvb_dialog_fragment);
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(com.luomor.liteav.demo.lvb.R.layout.fragment_pusher_more, container, false);
    }
    ...
    public void onViewCreated(final View view, @Nullable Bundle savedInstanceState) {
        ...
        mCbPrivateModel = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_private_mode));
        mCbPrivateModel.setOnCheckedChangeListener(this);
        mCbPrivateModel.setChecked(mPrivateModel);
        CheckBox cbMuteAudio = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_mute_audio));
        cbMuteAudio.setOnCheckedChangeListener(this);
        cbMuteAudio.setChecked(mMuteAudio);
        CheckBox cbMirror = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_mirror));
        cbMirror.setOnCheckedChangeListener(this);
        cbMirror.setChecked(mMirrorEnable);
        CheckBox cbFlashlight = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_flash_light));
        cbFlashlight.setOnCheckedChangeListener(this);
        cbFlashlight.setChecked(mFlashEnable);
        CheckBox cbDebugInfo = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_debug_info));
        cbDebugInfo.setOnCheckedChangeListener(this);
        cbDebugInfo.setChecked(mDebugInfo);
        CheckBox cbWaterMark = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_water_mark));
        cbWaterMark.setOnCheckedChangeListener(this);
        cbWaterMark.setChecked(mWaterMarkEnable);
        CheckBox cbFocus = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_focus));
        cbFocus.setOnCheckedChangeListener(this);
        cbFocus.setChecked(mFocusEnable);
        CheckBox cbZoom = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_zoom));
        cbZoom.setOnCheckedChangeListener(this);
        cbZoom.setChecked(mZoomEnable);
        CheckBox cbAudio = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_pure_audio));
        cbAudio.setOnCheckedChangeListener(this);
        cbAudio.setChecked(mPureAudio);

        mLlOrientation = (LinearLayout) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_ll_orientation);
        mCbOrientation = ((CheckBox) view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_cb_orientation));
        ...
        view.findViewById(com.luomor.liteav.demo.lvb.R.id.pusher_btn_snapshot).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        view.findViewById(com.luomor.liteav.demo.lvb.R.id.btn_send).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                OnMoreChangeListener listener = getListener();
                if (listener != null) {
                    EditText editText = (EditText) view.findViewById(com.luomor.liteav.demo.lvb.R.id.et_message);
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_private_mode) {
            mPrivateModel = isChecked;
            listener.onPrivateModeChange(mPrivateModel);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_mute_audio) {
            mMuteAudio = isChecked;
            listener.onMuteAudioChange(mMuteAudio);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_mirror) {
            mMirrorEnable = isChecked;
            listener.onMirrorChange(isChecked);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_flash_light) {
            mFlashEnable = isChecked;
            listener.onFlashLightChange(isChecked);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_debug_info) {
            mDebugInfo = isChecked;
            listener.onDebugInfoChange(isChecked);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_water_mark) {
            mWaterMarkEnable = isChecked;
            listener.onWaterMarkChange(isChecked);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_focus) {
            mFocusEnable = isChecked;
            listener.onFocusChange(isChecked);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_zoom) {
            mZoomEnable = isChecked;
            listener.onZoomChange(isChecked);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_orientation) {
            mIsPortrait = !isChecked;
            listener.onOrientationChange(mIsPortrait);
        } else if (id == com.luomor.liteav.demo.lvb.R.id.pusher_cb_pure_audio) {
