package com.luomor.liteav.demo.lvb.liveroom.ui.fragment;
...
import com.luomor.liteav.demo.lvb.liveroom.IMLVBLiveRoomListener;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.commondef.RoomInfo;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.misc.NameGenerator;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.widget.RoomListViewAdapter;
import com.luomor.liteav.demo.lvb.liveroom.ui.LiveRoomActivityInterface;
import com.luomor.liteav.demo.lvb.liveroom.roomutil.misc.HintDialog;
...
public class LiveRoomListFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.luomor.liteav.demo.lvb.R.layout.fragment_live_room_list, container, false);
...
//        });
        ...
        view.findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_create_room_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showCreateDialog();
            }
        ...
        ((SwipeRefreshLayout) view.findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_swiperefresh)).setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        ListView roomListView = ((ListView) view.findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_room_listview));
    ...
    private void showCreateDialog(){
        final View view = LayoutInflater.from(activity)
                .inflate(com.luomor.liteav.demo.lvb.R.layout.layout_rtmproom_dialog_create_room, null, false);
        EditText et = (EditText) view.findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_dialog_create_room_edittext);
        et.setHint("请输入直播间名称");
        new AlertDialog.Builder(activity, com.luomor.liteav.demo.lvb.R.style.RtmpRoomDialogTheme)
                .setView(view)
    ...
    private void enterRoom(final RoomInfo roomInfo, final String userID, final boolean requestCreateRoom) {
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                ts.replace(com.luomor.liteav.demo.lvb.R.id.rtmproom_fragment_container, roomFragment);
    ...
    public void freshRooms() {
        ...
        final SwipeRefreshLayout refreshView    = ((SwipeRefreshLayout) activity.findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_swiperefresh));
        final TextView enterRoomTips            = ((TextView) activity.findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_tip_textview));
        final TextView nullRoomTips             = ((TextView) activity.findViewById(com.luomor.liteav.demo.lvb.R.id.rtmproom_tip_null_list_textview));
