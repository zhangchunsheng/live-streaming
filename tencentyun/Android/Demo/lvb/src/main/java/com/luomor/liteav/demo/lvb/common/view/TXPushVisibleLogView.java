...
public class TXPushVisibleLogView extends RelativeLayout implements View.OnClickListener {
    ...
    public TXPushVisibleLogView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(com.luomor.liteav.demo.lvb.R.layout.view_push_visible_log, this);
        ...
        mTvBitrate = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_bitrate);
        mTvSpeed = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_speed);
        mTvEncoder = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_seg4);
