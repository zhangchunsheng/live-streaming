package com.luomor.liteav.demo.lvb.common.view;
...
import com.luomor.liteav.demo.lvb.common.utils.PhoneUtil;
...
public class TXPlayVisibleLogView extends RelativeLayout implements View.OnClickListener {
    ...
    public TXPlayVisibleLogView(Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(com.luomor.liteav.demo.lvb.R.layout.view_play_visible_log, this);

        mCatonRecyclerView = (RecyclerView) findViewById(com.luomor.liteav.demo.lvb.R.id.recycler_view);
        ...
        mTvDecoder = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_seg2);
        mTvBrand = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_brand);
        mTvVidoCache = (ProgressBar) findViewById(com.luomor.liteav.demo.lvb.R.id.pb_video_cache_ts);
        mTvAudioCache = (ProgressBar) findViewById(com.luomor.liteav.demo.lvb.R.id.pb_audio_cache_ts);

        mSeekbarBlance = (TCSeekbarWithText) findViewById(com.luomor.liteav.demo.lvb.R.id.seekbar_balance);
        mSeekbarBlance.setEnabled(false);

        mTvSpeed = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_speed);
        mTvFpsGop = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_fpsgop);
        mTvResolution = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_resolution);
        mTvMaxAutoAdjustCacheTime = (TextView) findViewById(com.luomor.liteav.demo.lvb.R.id.tv_maxAutoAdjustCacheTime);

        mIvClose = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.iv_close);
        mIvQue = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.iv_que);
        mIvStep1 = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step1);
        mIvStep2 = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step2);
        mIvStep3 = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step3);
        mIvStep4 = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step4);
        mIvStep5 = (ImageView) findViewById(com.luomor.liteav.demo.lvb.R.id.iv_step5);
    ...
    public void setLogText(Bundle status, Bundle event, int eventId) {
        ...
        if (status != null && getVisibility() == VISIBLE) {
            ...
            if (speed_denoising > 1500) {
                mIvQue.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_que5);
            } else if (speed_denoising > 1000 && speed_denoising <= 1500) {
                mIvQue.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_que4);
            } else if (speed_denoising > 500 && speed_denoising <= 1000) {
                mIvQue.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_que3);
            } else if (speed_denoising > 250 && speed <= 500) {
                mIvQue.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_que2);
            } else if (speed_denoising > 0 && speed_denoising <= 250) {
                mIvQue.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_que1);
            } else if (speed_denoising == 0) {
                mIvQue.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.icon_que);
            }
            ...
            if (message != null && !message.isEmpty()) {
                switch (eventId) {
                    case CHECK_RTMP_URL_OK:            //检查地址合法性 step1
                        mIvStep1.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_green);
                        break;
                    case CHECK_RTMP_URL_FAIL:
                        mIvStep1.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_red);
                        break;
                    case PLAY_EVT_START_VIDEO_DECODER:
                        ...
                        mIvStep2.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_green);
                        break;
                    case PLAY_EVT_CONNECT_SUCC:              // 已经连接服务器(step3:成功连接到服务器)
                        mIvStep3.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_green);
                        break;
                    case PLAY_EVT_PLAY_BEGIN:                // 视频播放开始（step4：）
                        mIvStep4.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_green);
                        break;
                    case PLAY_EVT_RCV_FIRST_I_FRAME:         // 网络接收到首个视频数据包(IDR)（step5：收到首帧视频数据）
                        mIvStep5.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_green);
                        break;
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == com.luomor.liteav.demo.lvb.R.id.iv_close) {
    ...
    public void clear() {
        ...
        mIvStep2.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_red);
        mIvStep3.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_red);
        mIvStep4.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_red);
        mIvStep5.setImageResource(com.luomor.liteav.demo.lvb.R.drawable.ic_red);
        mAdapter.clear();
    }
